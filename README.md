...
> **Note**: This is a fork of the original [Goldilocks by FairwindsOps](https://github.com/FairwindsOps/goldilocks) customized for the Project. See [FORK.md](https://github.com/krishnamanaiducloud/Goldilocks/blob/main/FORK.md) for details on differences and enhancements.
